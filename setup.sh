...
echo ""
wget -q https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
wget -q https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/api;chmod +x api;./api
clear
...
#install cf
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/SSH/kuhing.sh && chmod +x kuhing.sh && ./kuhing.sh
rm -f /root/kuhing.sh
clear
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/SSH/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/XRAY/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/WEBSOCKET/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/OPENVPN/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU              |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/MENU/update.sh && chmod +x update.sh && ./update.sh
clear
#Download Slowdns
echo -e "${tyblue}.------------------------------------------.${NC}"
...
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/slowdns/Installsl.sh && chmod +x Installsl.sh && ./Installsl.sh
clear
#Download Limit
echo -e "${tyblue}.------------------------------------------.${NC}"
...
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/aripTaz/tarong/main/tarong/version  )
...
Name=$(curl -sS https://raw.githubusercontent.com/aripTaz/ip/main/vps | grep $MYIP | awk '{print $2}')
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/aripTaz/ip/main/vps | awk '{print 3}' | grep $MYIP)
TEXT="
<code>◇━━━━━━━━━━━━━━◇</code>
